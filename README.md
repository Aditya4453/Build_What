...
**An AI-powered, citizen-first reimagining of India's vehicle & licence services — built for [Build What Moves India].**
...
**[buildwhat-seven.vercel.app](https://buildwhat-seven.vercel.app)**
...
A scoped conversational assistant that answers using the citizen's **actual application state** — eligibility, document requirements, policy questions — not a generic FAQ bot.
...
- [Aditya4453](https://github.com/Aditya4453)
- [justsamridhi](https://github.com/justsamridhi)
